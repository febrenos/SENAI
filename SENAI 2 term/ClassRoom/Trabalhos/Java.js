...
pessoa.apresentacao = function(){
  ...
  return "Ol�, eu sou o " + pessoa.nomeCompleto + ", tenho " + pessoa.idade + ano, " + pessoa.altura + ", meu peso � " + pessoa.peso + " e, s� hoje, eu j� caminhei " + pessoa.camihouQuantosMetros + metro + "!";
  } else {
